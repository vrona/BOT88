...
def roi(img, vertices):
    ...
    # fill the mask
    cv2.fillPoly(mask, vertices, (255,255,255)) # ,  ignore_mask_color
...
def hough_lines(original_image):
    ...
    # processed_img = cv2.Canny(original_image, threshold1=210, threshold2=500)

    vertices = np.array([[0,635],[0,317], [200,280], [600,280], [800,317], [800,635]], np.int32)
    roi_img = roi(original_image, [vertices])
